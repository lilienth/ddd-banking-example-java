...
public class CreditService {
	...
	public CreditCustomer newCustomer(String firstName, String familyName, LocalDate dateOfBirth, int customerNumber) {
		CreditCustomer customer = new CreditCustomer(firstName, familyName, dateOfBirth, customerNumber);
		customerList.put(customerNumber, customer);
		return customer;
